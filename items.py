...
try:
    ...
    # Simple Weapons
    catalog["Shortsword"] = Inanimate("Shortsword", item_code=1, cost=1000, details="A steel shortsword.", weight=2, alpha=1, beta=6, gamma="piercing")
    catalog["Club"] = Inanimate("Club", item_code=1, cost=10, details="A wooden club.", weight=2, alpha=1, beta=4, gamma="bludgeoning")
    catalog["Dagger"] = Inanimate("Dagger", item_code=1, cost=200, details="An iron dagger.", weight=1, alpha=1, beta=4, gamma="piercing")
    catalog["Greatclub"] = Inanimate("Greatclub", item_code=1, cost=20, details="A massive club.", weight=10, alpha=1, beta=8, gamma="bludgeoning")
    catalog["Handaxe"] = Inanimate("Handaxe", item_code=1, cost=500, details="A simple handaxe.", weight=2, alpha=1, beta=6, gamma="slashing")
    catalog["Javelin"] = Inanimate("Javelin", item_code=1, cost=50, details="A sturdy javelin.", weight=2, alpha=1, beta=6, gamma="slashing")
    catalog["Light Hammer"] = Inanimate("Light Hammer", item_code=1, cost=200, details="A smaller, lighter hammer.", weight=2, alpha=1, beta=4, gamma="bludgeoning")
    ...
    catalog["Quarterstaff"] = Inanimate("Quarterstaff", item_code=1, cost=200, details="A light and powerful staff.", weight=4, alpha=1, beta=6, gamma="bludgeoning")
    catalog["Sickle"] = Inanimate("Sickle", item_code=1, cost=100, details="A sharp sickle.", weight=2, alpha=1, beta=6, gamma="slashing")
    catalog["Spear"] = Inanimate("Spear", item_code=1, cost=100, details="A sharpened spear.", weight=3, alpha=1, beta=6, gamma="piercing")
